...
<div class="container">
    <div class="row">
        <form method="POST" action="{$_layoutParams.root}galeria/nuevo" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="col-md-4">
                    <div class="form-group" >
                        <div class="col-md-11 col-md-offset-1" id="contenedorImg">
                            <center><img class="text-center" src="{$_layoutParams.root}public/img/galeria.png" width="195" alt="No se encontro la ruta de la imagen" class="img-thumbnail"></center>
                        </div>
                    </div>
                    <div class="form-group">
